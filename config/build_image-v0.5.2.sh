...
# This script goes with Dockerfile_image-v0.5.2, comprising everything
# up to and including the boilerplate backing image at that version. As
# of now, it is no longer built directly/explicitly, but is preserved to
# make it easier to tell what's in subsequent versions (without having
# to paw through git history).
